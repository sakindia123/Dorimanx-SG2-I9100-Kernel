...
#export CROSS_COMPILE=/home/halaszk/android_build/SGS3/kernel/toolchains/arm-eabi-linaro-4.7.2/bin/arm-eabi-
...
zip -r Kernel-$GETVER-`date +"-%H-%M--%d-%m-12-SGSIII-PWR-CORE"`.zip .
