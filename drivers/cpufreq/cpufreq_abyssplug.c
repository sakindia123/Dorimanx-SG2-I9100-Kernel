...
/* Table for use with Samsung GT-I9300 */
static int tb_freqs_power[20][3]={
    {1800000,1800000,1704000},
    {1704000,1800000,1600000},
...
static void dbs_check_cpu(struct cpu_dbs_info_s *this_dbs_info)
{
	...
	if (max_load > dbs_tuners_ins.up_threshold) {
        ...
        this_dbs_info->requested_freq = tb_get_next_freq(policy->cur, TB_UP, max_load);
	...
	if (max_load < (dbs_tuners_ins.down_threshold - 10)) {
        ...
        this_dbs_info->requested_freq = tb_get_next_freq(policy->cur, TB_DOWN, max_load);
